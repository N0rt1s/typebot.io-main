...
import { ButtonUnclickableItem, Item, ItemIndices } from '@typebot.io/schemas'
import React, { useRef, useState } from 'react'
import { isEmpty } from '@typebot.io/lib'
import { useGraph } from '@/features/graph/providers/GraphProvider'
import { ButtonsUnclickableItemSettings } from './ButtonsUnclickableItemSettings'
import { useTranslate } from '@tolgee/react'

type Props = {
  item: ButtonUnclickableItem
  indices: ItemIndices
  isMouseOver: boolean
}

export const ButtonsUnclickableItemNode = ({ item, indices, isMouseOver }: Props) => {
  ...
  const updateItemSettings = (settings: Omit<ButtonUnclickableItem, 'content'>) => {
      ...
      <Portal>
        <PopoverContent pos="relative" onMouseDown={handleMouseDown}>
          ...
          <PopoverBody
            ...
            ref={ref}
          >
            <ButtonsUnclickableItemSettings
              item={item}
