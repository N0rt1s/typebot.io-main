...
import { ButtonUnclickableItem, Condition } from '@typebot.io/schemas'
...
type Props = {
  ...
  onSettingsChange: (updates: Omit<ButtonUnclickableItem, 'content'>) => void
}

export const ButtonsUnclickableItemSettings = ({ item, onSettingsChange }: Props) => {
