...
type Props = {
  buttons: NonNullable<Theme['chat']>['buttonsUnclickable']
  onButtonsChange: (buttons: NonNullable<Theme['chat']>['buttonsUnclickable']) => void
}

export const ButtonsUnclickableTheme = ({ buttons, onButtonsChange }: Props) => {
  ...
  return (
    <Stack data-testid="buttons-Unclickable-theme">
