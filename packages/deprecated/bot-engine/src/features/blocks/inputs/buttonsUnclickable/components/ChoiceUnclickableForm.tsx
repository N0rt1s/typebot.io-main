...
import { ChoiceUnclickableInputBlock } from '@typebot.io/schemas'
import React, { useState } from 'react'
import { SendButton } from '../../../../../components/SendButton'

type ChoiceUnclickableFormProps = {
  block: ChoiceUnclickableInputBlock
  onSubmit: (value: InputSubmitContent) => void
}

export const ChoiceUnclickableForm = ({ block, onSubmit }: ChoiceUnclickableFormProps) => {
  const {
    typebot: { variables },
  } = useTypebot()
