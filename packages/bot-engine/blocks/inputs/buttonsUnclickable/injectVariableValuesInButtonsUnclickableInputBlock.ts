...
import { filterChoiceUnclickableItems } from './filterChoiceUnclickableItems'
import { deepParseVariables } from '@typebot.io/variables/deepParseVariables'
import { transformVariablesToList } from '@typebot.io/variables/transformVariablesToList'
import { updateVariablesInSession } from '@typebot.io/variables/updateVariablesInSession'

export const injectVariableValuesInButtonsUnclickableInputBlock =
  (state: SessionState) =>
    (block: ChoiceUnclickableInputBlock): ChoiceUnclickableInputBlock => {
      ...
      return deepParseVariables(variables)(filterChoiceUnclickableItems(variables)(block))
    }
