import { PictureButtonBlock, SessionState } from '@typebot.io/schemas'
import { ParsedReply } from '../../../types'
import { injectVariableValuesInPictureButtonBlock } from './injectVariableValuesInPictureChoiceBlock'
import { isNotEmpty } from '@typebot.io/lib/utils'

export const parsePictureButtonReply =
  (state: SessionState) =>
    (inputValue: string, block: PictureButtonBlock): ParsedReply => {
      const displayedItems = injectVariableValuesInPictureButtonBlock(
